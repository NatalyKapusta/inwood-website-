-- ============================================================================
-- IN WOOD — нова роль "manager" (штатний менеджер IN WOOD).
-- Бачить усі 6 тарифів (як staff) і повний конструктор КП, але БЕЗ права
-- на ручне перевизначення ціни/розміру, керування користувачами чи
-- перемикачем видимості цін — ці можливості лишаються лише в staff.
-- Виконати цілком у Supabase Dashboard → SQL Editor.
-- ============================================================================

alter table public.profiles drop constraint if exists profiles_role_check;
alter table public.profiles add constraint profiles_role_check
  check (role in ('dealer', 'dealer_distributor', 'manager', 'staff'));
