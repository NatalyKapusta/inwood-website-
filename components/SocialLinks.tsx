...
// Суцільна золота "плашка" — так іконки лишаються добре видимими
// незалежно від фону (темна шапка/футер чи світла сторінка контактів).
const iconClass =
  "flex h-10 w-10 items-center justify-center rounded-full bg-gold text-navy-dark shadow-sm transition hover:-translate-y-0.5 hover:bg-gold-dim hover:shadow-md";
